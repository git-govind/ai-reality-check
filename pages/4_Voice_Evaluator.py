"""
pages/4_Voice_Evaluator.py — Voice Evaluator (coming soon)
"""
import sys
import os
...
st.set_page_config(
    page_title="Voice Evaluator — VeritasIQ",
    page_icon="🎙️",
    layout="wide",
)
...
st.markdown(
    ...
    <div style="text-align:center; padding: 5rem 2rem;">
        ...
        <h1 style="font-size:2rem; font-weight:800; margin-bottom:0.5rem;">Voice Evaluator</h1>
        ...
        <p style="color:#4b5563; font-size:0.9rem; margin-top:1rem; max-width:480px; margin-left:auto; margin-right:auto;">
            Analyse spoken content for authenticity, deepfake detection,
            and AI-generated speech — powered by the same forensics-first
            approach as the Image Evaluator.
        </p>
    </div>
    """,
    unsafe_allow_html=True,
